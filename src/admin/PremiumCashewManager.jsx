...
import { useNavigate } from "react-router-dom";
import usePremiumCashew from "./components/premiumcashew/usePremiumCashew";
import DeleteConfirmModal from "./components/premiumcashew/DeleteConfirmModal";
import ManageForm from "./components/premiumcashew/ManageForm";
import ExportForm from "./components/premiumcashew/ExportForm";
...
const PremiumCashewManager = () => {
  ...
  return (
    <div className="bg-white rounded-lg shadow-md p-4 sm:p-6">
      ...
      {/* Loading */}
      {loading && (
        <div className="text-center py-2 text-[#2E8B57]">Loading...</div>
      )}
      ...
      {activeTab === "manage" ? (
        ...
        <ExportForm
          ...
          setExportFormData={setExportFormData}
          exportEditingId={exportEditingId}
          loading={loading}
          exportProducts={exportProducts}
          onSubmit={handleExportSubmit}
          onEdit={handleExportEdit}
          onDelete={handleDeleteClick}
          onCancelEdit={handleCancelEdit}
          onAddSize={addSizeField}
          onRemoveSize={removeSizeField}
