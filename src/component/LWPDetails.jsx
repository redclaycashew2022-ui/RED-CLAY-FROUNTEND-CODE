...
const LWPDetails = ({ onClose }) => {
  ...
  const tabContent = {
    features: (
      ...
      >
        {[
          { icon: "🧩", text: "Form: Large broken pieces (not powder)" },
          { icon: "💰", text: "Value: Most economical cashew option" },
          { icon: "👅", text: "Flavor: Same as whole cashews" },
          { icon: "🍽️", text: "Perfect for: Cooking and baking" },
        ...
        {[
          {
            ...
            text: "High in healthy monounsaturated fats for heart health",
          },
          {
            icon: <FaFire className="text-orange-500 text-xl" />,
            text: "Packed with plant-based protein for muscle repair",
          },
          {
            icon: <FaSeedling className="text-green-500 text-xl" />,
            text: "Rich in minerals like magnesium, copper, and phosphorus",
          },
          {
            icon: <FaBrain className="text-blue-500 text-xl" />,
            text: "Supports brain function and energy production",
          },
          {
            icon: <FaLeaf className="text-[#2E8B57] text-xl" />,
            text: "Naturally cholesterol-free and gluten-free",
          },
          {
            icon: <FaShieldAlt className="text-purple-500 text-xl" />,
            text: "Contains antioxidants that support immune health",
          },
        ].map((item, index) => (
          <motion.div
            key={index}
    ...
    usage: (
      ...
      >
        {[
          <>
            <FaCookie className="inline mr-2 text-[#C1440E]" /> Ideal for sweets
            like barfi, halwa, and laddu
          </>,
          <>
            <FaCookie className="inline mr-2 text-[#C1440E]" /> Common in bakery
            items such as cookies, brownies, and cakes
          </>,
          <>
            <FaIceCream className="inline mr-2 text-[#C1440E]" /> Perfect for
            sprinkling over salads, yogurt, or ice cream
          </>,
          "🥄 Blends smoothly into sauces, curries, and nut butters",
          "🍛 Great for making kaju katli or cashew paste for gravies",
        ].map((item, index) => (
          <motion.div
            key={index}
            whileHover={{ x: 5 }}
        ...
        <div className="px-4 sm:px-8 pt-12 pb-32 overflow-y-auto flex-1 hide-scrollbar">
          ...
          <div className="mb-6">
            <h1 className="text-2xl sm:text-3xl font-bold text-[#2E8B57] mb-2">
              LWP Cashews – Lightly Broken, Fully Flavorful
            </h1>
            <p className="text-gray-600 text-sm sm:text-base">
              Same great taste in convenient pieces
            </p>
          </div>
            ...
            <div className="lg:w-3/5">
              ...
              <div className="mb-6 bg-[#FAF9F6] p-4 rounded-lg">
                ...
                <p className="text-gray-700">
                  LWP (Large White Pieces) cashews are broken kernels that
                  retain the same rich, buttery flavor and creamy texture as
                  whole cashews. Their convenient size makes them perfect for
                  cooking, baking, and blending.
                </p>
              </div>
