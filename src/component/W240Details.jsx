...
const W240Details = ({ onClose }) => {
  ...
  const [product, setProduct] = useState({
    ...
    description: "Standard Large grade - Perfect balance of size and value",
    sizes: [],
    stock: 60,
    rating: 4.5,
  });
  ...
  const tabContent = {
    features: (
      ...
      >
        {[
          {
            icon: <FaBalanceScale className="text-[#2E8B57] text-xl" />,
            text: "Grade: W240 (240 nuts per pound)",
          },
          {
            icon: "⚖️",
          ...
          {
            icon: "👌",
            text: "Texture: Smooth and crunchy",
          },
          {
            icon: "👅",
            text: "Flavor: Mildly sweet and nutty",
          },
          {
        ...
        {[
          {
            ...
            text: "Heart health: Contains healthy unsaturated fats",
          },
          {
            icon: <FaFire className="text-orange-500 text-xl" />,
            text: "Energy: Provides sustained energy throughout the day",
          },
          {
            icon: <FaSeedling className="text-green-500 text-xl" />,
            text: "Nutrition: Rich in magnesium, zinc, and copper",
          },
          {
            icon: <FaLeaf className="text-[#2E8B57] text-xl" />,
          ...
          },
          {
            ...
            text: "Immunity: Contains antioxidants for cell protection",
          },
        ].map((item, index) => (
          <motion.div
            key={index}
    ...
    usage: (
      ...
      >
        {[
          ...
          "🎁 Gifting: A practical and nutritious gift",
        ].map((item, index) => (
          <motion.div
            key={index}
            whileHover={{ x: 5 }}
            ...
            <div className="lg:w-3/5">
              ...
              <div className="mb-6 bg-[#FAF9F6] p-4 rounded-lg">
                ...
                <p className="text-gray-700">
                  Our W240 Whole White Cashews offer the perfect balance between
                  size and value. These premium cashews are slightly smaller
                  than the W210 grade but maintain excellent quality and flavor.
                  Ideal for everyday use, the W240 grade provides great value
                  while still delivering the creamy texture and rich taste that
                  Red Clay Cashews are known for.
                </p>
              </div>
      ...
      {isImageZoomed && (
        ...
        >
          ...
          <div className="max-w-4xl w-full h-full flex items-center justify-center">
            <img
              src={W240}
              alt="Zoomed Whole White W240 Cashews"
