...
const W450Details = ({ onClose }) => {
  ...
  const tabContent = {
    features: (
      ...
      >
        {[
          ...
          {
            icon: "💰",
            text: "Value: Budget-friendly premium quality",
          },
          {
            icon: "👌",
            text: "Texture: Delicate yet crunchy",
          },
          {
            icon: "👅",
            text: "Flavor: Mildly sweet, slightly buttery",
          },
          {
            icon: "🌿",
      ...
      >
        {[
          ...
          },
          {
            ...
            text: "Energy: High in plant-based protein",
          },
          {
          ...
          },
          {
            ...
            text: "Weight management: Lower calorie count per nut",
          },
          {
    ...
    usage: (
      ...
      >
        {[
          "🔥 Ideal for roasting and seasoning",
          "🥜 Perfect for trail mixes and snack packs",
          "🍬 Used in sweets like kaju katli, laddu, and fudge",
          "🍽️ Garnish for curries, desserts, and baked goods",
          "🥣 Great for grinding into cashew paste for gravies or sauces",
          "🎁 Excellent for bulk cooking and gifting",
        ].map((item, index) => (
          <motion.div
            key={index}
            whileHover={{ x: 5 }}
            ...
            <div className="lg:w-3/5">
              ...
              <div className="mb-6 bg-[#FAF9F6] p-4 rounded-lg">
                ...
                <p className="text-gray-700">
                  ...
                  delicate size, they are budget-friendly yet maintain excellent
                  quality.
                </p>
              </div>
